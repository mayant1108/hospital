export const SITE_CONTENT = {
  ...
  carePath: [
    ...
    },
    {
      ...
      description: 'Get consultation, diagnostics, prescriptions, and follow-up guidance.',
      icon: 'CheckCircle2',
    },
  ],
  testimonials: [
...
export const DEFAULT_DEPARTMENTS = [
  ...
  },
  {
    ...
    icon: 'Activity',
    description:
      'Fever, diabetes, hypertension, infections, and long-term disease management.',
    services: ['Diabetes care', 'Fever clinic', 'Hypertension care'],
  },
  {
    name: 'Gynecology',
    icon: 'UsersRound',
    description:
      'Women health, maternity planning, prenatal visits, and preventive screenings.',
    services: ['Maternity care', 'Prenatal visits', 'Screenings'],
  },
];

export const DEPARTMENT_DETAILS = DEFAULT_DEPARTMENTS.reduce((acc, item) => {
